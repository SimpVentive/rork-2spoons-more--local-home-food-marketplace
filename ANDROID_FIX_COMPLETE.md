...
- Changed `newArchEnabled: false` in app-optimized.json
...
- Fixed all image rendering issues in OptimizedImage.tsx
...
### Step 5: Build with EAS (if needed)
```bash
