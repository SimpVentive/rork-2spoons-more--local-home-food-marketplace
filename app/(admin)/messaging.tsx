...
export default function AdminMessagingScreen() {
  ...
  try {
    ...
    setUserDetails(response.data); // assuming setUserDetails is defined in your component
  } catch (error: any) {
    console.error('Failed to load user details:', error?.response?.data || error.message);
  }
};
